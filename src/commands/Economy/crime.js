...
const CRIME_TYPES = [
    { name: "Pickpocketing", min: 10, max: 50, risk: 0.5 },
    { name: "Burglary", min: 30, max: 100, risk: 0.8 },
    { name: "Bank Heist", min: 100, max: 500, risk: 10 },
    { name: "Art Theft", min: 200, max: 1000, risk: 50 },
    { name: "Cybercrime", min: 500, max: 2000, risk: 95 },
];
